    ...
    <section>
      <div className="mx-auto max-w-max px-6 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-48">
        ...
        <ul className="w-full">
          ...
          <li className="w-full border-b-2 border-secondary border-opacity-100 py-4">Kami akan membangun website Anda menggunakan WordPress, platform yang populer dan mudah dikelola.</li>
